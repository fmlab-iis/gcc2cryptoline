...
mov output6_0@uint64 a0;
mov output6_8@uint64 a1;
mov output6_16@uint64 a2;
mov output6_24@uint64 a3;
mov output6_32@uint64 a4;
...
assert true && tmp_to_use_p = r034;
assume tmp_to_use_p = r034 && true;
...
vpc tmp_to_use_p@uint64 tmp_to_use;
assert true && tmp_to_use_p = r040;
assume tmp_to_use_p = r040 && true;
...
vpc tmp_to_use_p@uint64 tmp_to_use;
assert true && tmp_to_use_p = r046;
assume tmp_to_use_p = r046 && true;
...
vpc tmp_to_use_p@uint64 tmp_to_use;
assert true && tmp_to_use_p = r052;
assume tmp_to_use_p = r052 && true;
...
assert true && tmp_to_use = b4_11;
assume tmp_to_use = b4_11 && true;
...
vpc tmp_to_use_p@uint64 tmp_to_use;
assert true && tmp_to_use_p = i0_16;
assume tmp_to_use_p = i0_16 && true;
...
mov c0 output6_0@uint64;
mov c1 output6_8@uint64;
mov c2 output6_16@uint64;
mov c3 output6_24@uint64;
mov c4 output6_32@uint64;
