(* @frege
===== Verification =====
Arguments: -jobs 24 -qfbv_solver boolector -qfbv_args "-SE lingeling" -btor -isafety -slicing -isafety_timeout 99999999 ./fe_add_tuned.cl
Verification result:			[OK]		0.570165 seconds
	Command being timed: "verify -jobs 24 -qfbv_solver boolector -qfbv_args -SE lingeling -btor -isafety -slicing -isafety_timeout 99999999 ./fe_add_tuned.cl"
	...
	Minor (reclaiming a frame) page faults: 71609
...
(* @mac 
===== Verification =====
Arguments: -jobs 4 -qfbv_solver boolector -qfbv_args "-SE lingeling" -btor -isafety -slicing -isafety_timeout 99999999 ./fe_add_tuned.cl
Verification result:			[OK]		1.356047 seconds
        1.53 real         0.94 user         1.04 sys
   6635520  maximum resident set size
         0  average shared memory size
         0  average unshared data size
         0  average unshared stack size
    245052  page reclaims
      1263  page faults
         0  swaps
        31  block input operations
         ...
         0  messages sent
         0  messages received
       361  signals received
       719  voluntary context switches
      3903  involuntary context switches
*)
