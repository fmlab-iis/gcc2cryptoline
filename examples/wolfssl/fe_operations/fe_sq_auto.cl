...
(* _59 = h0_174 + 33554432; *)
sadd v59 h0174 0x2000000@int64;
(* carry0_184 = _59 >> 26; *)
...
(* _61 = h4_178 + 33554432; *)
sadd v61 h4178 0x2000000@int64;
(* carry4_187 = _61 >> 26; *)
(* TODO: signed operation, need check *)
...
(* _63 = h1_185 + 16777216; *)
sadd v63 h1185 0x1000000@int64;
(* carry1_190 = _63 >> 25; *)
(* TODO: signed operation, need check *)
...
(* _65 = h5_188 + 16777216; *)
sadd v65 h5188 0x1000000@int64;
(* carry5_193 = _65 >> 25; *)
(* TODO: signed operation, need check *)
...
(* _67 = h2_191 + 33554432; *)
sadd v67 h2191 0x2000000@int64;
(* carry2_196 = _67 >> 26; *)
(* TODO: signed operation, need check *)
...
(* _69 = h6_194 + 33554432; *)
sadd v69 h6194 0x2000000@int64;
(* carry6_199 = _69 >> 26; *)
(* TODO: signed operation, need check *)
...
(* _71 = h3_197 + 16777216; *)
sadd v71 h3197 0x1000000@int64;
(* carry3_202 = _71 >> 25; *)
(* TODO: signed operation, need check *)
...
(* _73 = h7_200 + 16777216; *)
sadd v73 h7200 0x1000000@int64;
(* carry7_205 = _73 >> 25; *)
(* TODO: signed operation, need check *)
...
(* _75 = h4_203 + 33554432; *)
sadd v75 h4203 0x2000000@int64;
(* carry4_208 = _75 >> 26; *)
(* TODO: signed operation, need check *)
...
(* _77 = h8_206 + 33554432; *)
sadd v77 h8206 0x2000000@int64;
(* carry8_211 = _77 >> 26; *)
(* TODO: signed operation, need check *)
...
(* _79 = h9_212 + 16777216; *)
sadd v79 h9212 0x1000000@int64;
(* carry9_214 = _79 >> 25; *)
(* TODO: signed operation, need check *)
ssplit carry9214 tmp_to_use v79 25;
(* _80 = carry9_214 * 19; *)
smul v80 carry9214 0x13@int64;
(* h0_215 = _80 + h0_186; *)
...
(* _82 = h0_215 + 33554432; *)
sadd v82 h0215 0x2000000@int64;
(* carry0_217 = _82 >> 26; *)
(* TODO: signed operation, need check *)
...
(* _84 = (int) h0_219; *)
cast v84@int32 h0219@int64;
(* *h_220(D) = _84; *)
mov h220_0 v84;
(* _85 = (int) h1_218; *)
cast v85@int32 h1218@int64;
(* MEM[(int32_t * )h_220(D) + 4B] = _85; *)
mov h220_4 v85;
(* _86 = (int) h2_198; *)
cast v86@int32 h2198@int64;
(* MEM[(int32_t * )h_220(D) + 8B] = _86; *)
mov h220_8 v86;
(* _87 = (int) h3_204; *)
cast v87@int32 h3204@int64;
(* MEM[(int32_t * )h_220(D) + 12B] = _87; *)
mov h220_12 v87;
(* _88 = (int) h4_210; *)
cast v88@int32 h4210@int64;
(* MEM[(int32_t * )h_220(D) + 16B] = _88; *)
mov h220_16 v88;
(* _89 = (int) h5_209; *)
cast v89@int32 h5209@int64;
(* MEM[(int32_t * )h_220(D) + 20B] = _89; *)
mov h220_20 v89;
(* _90 = (int) h6_201; *)
cast v90@int32 h6201@int64;
(* MEM[(int32_t * )h_220(D) + 24B] = _90; *)
mov h220_24 v90;
(* _91 = (int) h7_207; *)
cast v91@int32 h7207@int64;
(* MEM[(int32_t * )h_220(D) + 28B] = _91; *)
mov h220_28 v91;
(* _92 = (int) h8_213; *)
cast v92@int32 h8213@int64;
(* MEM[(int32_t * )h_220(D) + 32B] = _92; *)
mov h220_32 v92;
(* _93 = (int) h9_216; *)
cast v93@int32 h9216@int64;
