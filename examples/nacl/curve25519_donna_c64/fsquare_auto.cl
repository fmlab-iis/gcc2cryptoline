...
mov in70_0@uint64 _;
mov in70_8@uint64 _;
mov in70_16@uint64 _;
mov in70_24@uint64 _;
mov in70_32@uint64 _;
...
mov _ output71_0@uint64;
mov _ output71_8@uint64;
mov _ output71_16@uint64;
mov _ output71_24@uint64;
mov _ output71_32@uint64;
(* End with unsed lhs *)
