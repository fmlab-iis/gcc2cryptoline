...
(* th_103 = (uint64_t) _8; *)
cast th103@uint64 v8@uint128;
(* tl_104 = (uint64_t) t_102; *)
cast tl104@uint64 t102@uint128;
(* th2_105 = th_103 * 2; *)
umul th2105 th103 0x2@uint64;
(* _216 = th_103 > th2_105; *)
...
uadd th2109 th2107 v218;
(* _10 = th2_109 == 0; *)
subb lt_value dontcare th2109 0x0@uint64;
subb gt_value dontcare 0x0@uint64 th2109;
...
(* th_114 = (uint64_t) _17; *)
cast th114@uint64 v17@uint128;
(* tl_115 = (uint64_t) t_113; *)
cast tl115@uint64 t113@uint128;
(* th2_116 = th_114 * 2; *)
umul th2116 th114 0x2@uint64;
(* _219 = th_114 > th2_116; *)
...
uadd th2120 th2118 v224;
(* _19 = th2_120 == 0; *)
subb lt_value dontcare th2120 0x0@uint64;
subb gt_value dontcare 0x0@uint64 th2120;
...
(* th_134 = (uint64_t) _29; *)
cast th134@uint64 v29@uint128;
(* tl_135 = (uint64_t) t_133; *)
cast tl135@uint64 t133@uint128;
(* th2_136 = th_134 * 2; *)
umul th2136 th134 0x2@uint64;
(* _231 = th_134 > th2_136; *)
...
uadd th2140 th2138 v236;
(* _31 = th2_140 == 0; *)
subb lt_value dontcare th2140 0x0@uint64;
subb gt_value dontcare 0x0@uint64 th2140;
...
(* th_145 = (uint64_t) _38; *)
cast th145@uint64 v38@uint128;
(* tl_146 = (uint64_t) t_144; *)
cast tl146@uint64 t144@uint128;
(* th2_147 = th_145 * 2; *)
umul th2147 th145 0x2@uint64;
(* _239 = th_145 > th2_147; *)
...
uadd th2152 th2150 v244;
(* _40 = th2_152 == 0; *)
subb lt_value dontcare th2152 0x0@uint64;
subb gt_value dontcare 0x0@uint64 th2152;
...
(* th_159 = (uint64_t) _47; *)
cast th159@uint64 v47@uint128;
(* tl_160 = (uint64_t) t_158; *)
cast tl160@uint64 t158@uint128;
(* th2_161 = th_159 * 2; *)
umul th2161 th159 0x2@uint64;
(* _250 = th_159 > th2_161; *)
...
uadd th2165 th2163 v252;
(* _49 = th2_165 == 0; *)
subb lt_value dontcare th2165 0x0@uint64;
subb gt_value dontcare 0x0@uint64 th2165;
...
(* th_179 = (uint64_t) _59; *)
cast th179@uint64 v59@uint128;
(* tl_180 = (uint64_t) t_178; *)
cast tl180@uint64 t178@uint128;
(* th2_181 = th_179 * 2; *)
umul th2181 th179 0x2@uint64;
(* _259 = th_179 > th2_181; *)
...
uadd th2185 th2183 v261;
(* _61 = th2_185 == 0; *)
subb lt_value dontcare th2185 0x0@uint64;
subb gt_value dontcare 0x0@uint64 th2185;
...
mov _ l100_0@uint64;
mov _ l100_8@uint64;
mov _ l100_16@uint64;
mov _ l100_24@uint64;
mov _ l100_32@uint64;
mov _ l100_40@uint64;
mov _ l100_48@uint64;
mov _ l100_56@uint64;
(* End with unsed lhs *)
