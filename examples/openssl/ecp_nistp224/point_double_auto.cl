...
mov alpha_0@uint64 _;
mov alpha_8@uint64 _;
mov alpha_16@uint64 _;
mov alpha_24@uint64 _;
mov beta_0@uint64 _;
mov beta_8@uint64 _;
...
mov x_out14_0@uint64 _;
mov x_out14_8@uint64 _;
mov x_out14_16@uint64 _;
mov x_out14_24@uint64 _;
...
uadd v121 v551 0xfffeffffffffff00@uint128;
...
mov _ delta_0@uint64;
mov _ delta_8@uint64;
mov _ delta_16@uint64;
mov _ delta_24@uint64;
mov _ tmp_0@uint128;
