...
(* TODO: skipped, GIMPLE_CALL doesn't use internal or builtin function, inline function or self translte *)
call felem_shrink(beta_0, beta_16, beta_32, beta_48, small2_0, small2_8, small2_16, small2_24);
(* smallfelem_mul (&tmp, &small2, &small2); *)
(* TODO: skipped, GIMPLE_CALL doesn't use internal or builtin function, inline function or self translte *)
call smallfelem_mul(small2_0, small2_8, small2_16, small2_24, small2_0, small2_8, small2_16, small2_24, tmp_0, tmp_16, tmp_32, tmp_48 ,tmp_64, tmp_80 ,tmp_96, tmp_112);
(* small2 ={v} {CLOBBER}; *)
(* TODO: Skip translation for constructor *)
